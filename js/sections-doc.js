...
document.addEventListener('DOMContentLoaded', function() {
    ...
    codeEditorElements.forEach(element => {
        ...
        // Obtener el valor del atributo data-section-name del elemento
        //const dataSectionName = element.dataset.sectionName;

        /* 
        const sectionName = id.replace(/[.*+?^${}#()|[\]\\]/g, '') // Escapamos caracteres especiales en el nombre de la sección
        ...
        */
        //const dataSectionName = element.dataset.sectionName ? element.dataset.sectionName : sectionName;
        //const sectionName = formatIdToReadableText(id);
    
        //const sectionName = id.replace(/[.*+?^${}#()|[\]\\]/g, '').replace(/-/g, ' '); // formatear ID a texto legible
        ...
        //console.log('ID:', id);
        //console.log('Data Section Name:', dataSectionName);
        //console.log('Data Language:', dataLang);
        //console.log('Data Src:', dataSrc);

        // appendTargetID, sectionToExtract, lang, fileName
        console.log(sectionName)
